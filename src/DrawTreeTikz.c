...
void setFunctTikz(TypeFunctDrawTreeGeneric *funct) {
	funct->startStd = startTikzStd;
	funct->start = startTikz;
	funct->end = endTikz;
	funct->drawText = drawTextTikz;
	funct->drawTextAngle = drawTextAngleTikz;
	funct->drawLine = drawLineTikz;
	funct->drawDottedLine = drawDottedLineTikz;
	funct->fillWedge = fillWedgeTikz;
	funct->drawWedge = drawWedgeTikz;
	funct->fillGradient = fillGradientTikz;
}
